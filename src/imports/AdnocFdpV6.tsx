import svgPaths from "./svg-fh8n1r0t6b";
...
function Container9() {
  return <div className="absolute h-[943px] left-0 opacity-60 top-0 w-[679.5px]" data-name="Container" />;
}
...
function Container8() {
  return (
    <div className="absolute bg-gradient-to-b from-[#060a14] h-[943px] left-0 overflow-clip to-[#0d1424] top-0 w-[679.5px]" data-name="Container">
      <Container9 />
      <Container10 />
    </div>
  );
