import svgPaths from "./svg-7g4ke4y1jd";
...
function Text() {
  return (
    <div className="h-[20px] relative shrink-0 w-[29.672px]" data-name="Text">
...
function Container1() {
  return (
    <div className="absolute content-stretch flex h-[943px] items-center justify-center left-[679.5px] top-0 w-[679.5px]" data-name="Container">
      <Container2 />
    </div>
  );
}
...
function Container12() {
  return (
    <div className="absolute content-stretch flex flex-col h-[38px] items-start left-[11.81px] pb-px pt-[9px] px-[17px] rounded-[16777200px] top-0 w-[134.68px]" data-name="Container">
...
function Container13() {
  return (
    <div className="absolute content-stretch flex flex-col h-[38px] items-start left-[158.49px] pb-px pt-[9px] px-[17px] rounded-[16777200px] top-0 w-[181.688px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(0,188,212,0.2)] border-solid inset-0 pointer-events-none rounded-[16777200px]" />
      <Paragraph3 />
    </div>
  );
...
function Container14() {
  return (
    <div className="absolute content-stretch flex flex-col h-[38px] items-start left-[80.04px] pb-px pt-[9px] px-[17px] rounded-[16777200px] top-[50px] w-[191.914px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(0,188,212,0.2)] border-solid inset-0 pointer-events-none rounded-[16777200px]" />
      <Paragraph4 />
    </div>
  );
...
function Container9() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[32px] h-[432px] items-center left-[115.75px] py-[40px] rounded-[24px] top-[255.5px] w-[448px]" data-name="Container">
      <Container10 />
      <Heading />
      <Paragraph1 />
      <Container11 />
...
function Container() {
  return (
    <div className="h-[943px] relative shrink-0 w-full" data-name="Container">
      <Container1 />
      <Container8 />
    </div>
  );
