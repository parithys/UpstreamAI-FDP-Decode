...
```css
--background: rgba(248, 247, 252, 1.00)  /* Main app background */
--foreground: rgba(35, 25, 55, 1.00)     /* Main text color */
--card: rgba(255, 255, 255, 1.00)        /* Card/container background */
--card-foreground: rgba(25, 25, 38, 1.00) /* Card text */
```

**Brand Colors:**
```css
--primary: rgba(55, 35, 88, 1.00)        /* Primary purple */
--primary-foreground: rgba(255, 255, 255, 1.00)
--secondary: rgba(242, 237, 252, 1.00)   /* Light purple */
--secondary-foreground: rgba(55, 35, 88, 1.00)
--accent: rgba(123, 94, 167, 1.00)       /* Accent purple */
--accent-foreground: rgba(255, 255, 255, 1.00)
```

**UI State Colors:**
```css
--muted: rgba(242, 242, 245, 1.00)       /* Disabled/subtle */
--muted-foreground: rgba(153, 153, 165, 1.00)
--destructive: rgba(212, 32, 32, 1.00)   /* Danger red */
...
--danger: var(--destructive) /* Red - rgba(212, 32, 32, 1.00) */
--warning: var(--chart-4)   /* Amber - rgba(245, 158, 11, 1.00) */
--info: var(--chart-2)      /* Blue - rgba(59, 130, 246, 1.00) */
```

**Chart Colors:**
```css
--chart-1: rgba(93, 75, 122, 1.00)   /* Purple */
--chart-2: rgba(59, 130, 246, 1.00)  /* Blue */
--chart-3: rgba(34, 197, 94, 1.00)   /* Green */
--chart-4: rgba(245, 158, 11, 1.00)  /* Amber */
--chart-5: rgba(212, 32, 32, 1.00)   /* Red */
```

**Sidebar Colors:**
```css
--sidebar: rgba(30, 19, 52, 1.00)    /* Dark purple background */
--sidebar-foreground: rgba(192, 192, 204, 1.00)
--sidebar-primary: rgba(55, 35, 88, 1.00)
--sidebar-accent: rgba(123, 94, 167, 1.00)
--sidebar-border: rgba(224, 224, 231, 1.00)
```

**Border & Input Colors:**
```css
--border: rgba(224, 224, 231, 1.00)
--input: rgba(250, 250, 252, 1.00)   /* Filled input background */
--input-background: rgba(255, 255, 255, 1.00) /* Input background */
--ring: rgba(55, 35, 88, 1.00)       /* Focus ring color */
```
...
--text-label: 12px   /* Labels, badges */
--text-caption: 12px /* Small text, captions */
--text-body-small: 13px /* Small body text */
```
...
--radius-button: 8px       /* Button radius */
--radius-card: 12px        /* Card radius */
--radius-sm: 4px          /* Small radius (calc(var(--radius) - 4px)) */
--radius-md: 6px          /* Medium radius (calc(var(--radius) - 2px)) */
--radius-lg: 8px          /* Large radius (var(--radius)) */
--radius-xl: 12px         /* Extra large radius (calc(var(--radius) + 4px)) */
```
...
**Variants:**
```typescript
variant: "default" | "primary" | "secondary" | "ghost" | "pill" | 
...
type WorkflowStageStatus = 
  'not-started' | 'ready' | 'in-progress' | 'blocked' | 'completed' | 'failed';
```
...
```css
--chart-1: rgba(93, 75, 122, 1.00)   /* Purple - Primary data series */
--chart-2: rgba(59, 130, 246, 1.00)  /* Blue - Secondary series */
--chart-3: rgba(34, 197, 94, 1.00)   /* Green - Positive/success */
--chart-4: rgba(245, 158, 11, 1.00)  /* Amber - Warning/caution */
--chart-5: rgba(212, 32, 32, 1.00)   /* Red - Negative/danger */
```
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="p-8">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-h1 text-foreground">FDP Nerve Center</h1>
          ...
          <Card variant="default">
            ...
            <CardContent>
              <p className="text-body-small text-text-secondary mb-4">
                Monitor data quality and completeness across all disciplines
              </p>
...
export function UserForm() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="p-8 max-w-4xl mx-auto">
        <div className="mb-6">
          <h1 className="text-h1 text-foreground">Create User</h1>
          <p className="text-body text-text-secondary mt-2">
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardContent className="p-6 space-y-6">
              ...
              <div>
                <label htmlFor="role" className="text-label text-text-secondary mb-1.5 block">
                  Role
                </label>
                <Select
                  value={formData.role}
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="engineer">Reservoir Engineer</SelectItem>
                    <SelectItem value="geoscientist">Geoscientist</SelectItem>
                    <SelectItem value="executive">Executive</SelectItem>
                  </SelectContent>
                </Select>
                {errors.role && (
                  <p className="text-caption text-danger mt-1.5">{errors.role}</p>
                )}
              </div>
            </CardContent>
...
const wells: Well[] = [
  { id: '1', name: 'Well-001', status: 'active', production: 1250, pressure: 3200 },
  { id: '2', name: 'Well-002', status: 'active', production: 980, pressure: 3100 },
  { id: '3', name: 'Well-003', status: 'inactive', production: 0, pressure: 2800 }
];
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="p-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Well List ({filteredWells.length} wells)</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
